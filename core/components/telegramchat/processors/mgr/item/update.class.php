...
class TelegramChatItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('telegramchat_item_err_ns');
        }
...
return 'TelegramChatItemUpdateProcessor';
